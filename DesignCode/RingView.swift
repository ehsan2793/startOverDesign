...
struct RingView: View {
    ...
    var purpleColor = Color(#colorLiteral(red: 0.2196078449, green: 0.007843137719, blue: 0.8549019694, alpha: 1))
    ...
    var body: some View {
        ZStack {
            ...
            Circle()
                ...
                .frame(width: 44, height: 44)
                .shadow(color: purpleColor.opacity(0.1), radius: 3, x: 0, y: 3)
